...
namespace WebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(255, ErrorMessage = "The first name field have a maximum of 255 characters")]
            [Display(Name = "Firstname")]
            public string FirstName { get; set; }

            [Required]
            [StringLength(255, ErrorMessage = "The middle name field have a maximum of 255 characters")]
